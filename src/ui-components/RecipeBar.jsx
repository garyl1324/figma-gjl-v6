...
export default function RecipeBar(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "RecipeBar")}
    >
      <Flex
        gap="2px"
        direction="row"
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="GaryRecipes"
          {...getOverrideProps(overrides, "GaryRecipes")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32130812892")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32130812897")}
      >
        <SearchField
          display="flex"
          gap="8px"
